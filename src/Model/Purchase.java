...
public class Purchase {
    ...
    public Purchase(int id, int code, String product_name, int purchase_amount, double purchase_price, double purchase_subtotal, double total, String created, String supplier_name_product, String purcharser) {
        this.id = id;
        this.code = code;
