...
public class Message extends javax.swing.JPanel {
    ...
    public Message(String tittle,String subtitle) {
        initComponents(tittle, subtitle);
        setOpaque(false);
    ...
    private void initComponents(String tittle, String subtitle) {

        jLabel1 = new javax.swing.JLabel();
        txt = new javax.swing.JTextPane();
        cmdOK = new View.SimpleMessage.Button();
        cmdCancel = new View.SimpleMessage.Button();
    ...
    private View.SimpleMessage.Button cmdCancel;
    private View.SimpleMessage.Button cmdOK;
