...
public class JP_ProductRegister extends javax.swing.JPanel {
    ...
    /**
     * Creates new form JP_ProductRegister
     */
    ...
    private void initComponents() {
        ...
        txt_product_price.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_product_priceKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
    ...
    private void txt_product_priceKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_product_priceKeyReleased

// if(txt_product_price.getText().matches("^[0-9]+([.][0-9]+)?$")){
      //      evt.consume();
      //  };
    }//GEN-LAST:event_txt_product_priceKeyReleased
