...
public class ShapedButtonUICancel extends BasicButtonUI {

  /** Button shape. */
  private ShapedButton.ButtonShape shape;

  public ShapedButtonUICancel() {
   super();
  }
  ...
  public void paint(Graphics g, JComponent c) {
   ...
   GradientPaint gp = new GradientPaint(0, 0, new Color(237, 94, 104), c.getWidth(), c.getHeight(), new Color(179, 7, 6));
   g2d.setPaint(gp);
  ...
  protected void paintButtonPressed(Graphics g, AbstractButton b) {
   ...
   // establecemos un gradiente para el fondo del boton
       GradientPaint gp = new GradientPaint(0, 0, new Color(237, 94, 104), 0, b.getHeight(),  new Color(179, 7, 6));
   g2d.setPaint(gp);
   g2d.fill(buttonShape);
  }
 }