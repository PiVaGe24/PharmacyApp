...
public class JF_Print extends javax.swing.JFrame {
    //Patron SINGLETON
    //private static JF_Print INSTANCE = null;
    ...
    //Patron singleton
    /*private synchronized static void createInstance(int id) {
        if (INSTANCE == null) { 
            INSTANCE = new JF_Print(id);
        }
    }*/
    
    //Patron Singleton
    /*public static JF_Print getInstance(int id) {
        if (INSTANCE == null) createInstance(id);
        return INSTANCE;
    }*/
 /*   
    private static JF_Print jfPrint;
    
    private JF_Print(){
    }
    public static JF_Print getPrint(){
        if(jfPrint==null){
            jfPrint = new JF_Print();
        }
        return jfPrint;
    }
*/
    /*public void ListAllPurchaseDetail(int id){
        ...
        for (int i = 0; i < listPurchase.size(); i++) {
            row[0] = listPurchase.get(i).getProduct_name();
            row[1] = listPurchase.get(i).getPurchase_amount();
            row[2] = listPurchase.get(i).getPurchase_price();
            row[3] = listPurchase.get(i).getPurchase_subtotal();
            row[4] = listPurchase.get(i).getSupplier_name_product();
            row[5] = listPurchase.get(i).getPurcharser();
            row[6] = listPurchase.get(i).getCreated();
    ...
    /*    //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF_Print.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
